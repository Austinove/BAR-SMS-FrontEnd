        ...
        <div>
            {
                ...
                <Button color="light" size="sm" block onClick={toggle} className="float-left" type="button">
                    {btnSpan(btnSpan_className, btn_icon, buttonLabel)}
                </Button> :
                <Button color="light" size="sm" onClick={toggle} className="float-left" type="button">
                    {btnSpan(btnSpan_className, btn_icon, buttonLabel)}
                </Button>
            }
            <Modal
                        ...
                        <Row>
                            ...
                            <Col md="4">
                                <Button type="submit" color="light">
                                    <i className={subLabel === "Submit Sale" ? btn_icon : "fa fa-plus-circle"} /> 
                                    {subLabel}
                                </Button>
                            </Col>
                        </Row>
